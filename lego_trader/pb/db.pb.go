...
type DBUser struct {
	...
	Id       string `protobuf:"bytes,1,opt,name=id,proto3" json:"id" gorm:"id;primaryKey"` //id
...
type DBUserStock struct {
	...
	Id      uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id" gorm:"id;primaryKey;autoIncrement"`      //id
	UserId  string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id" gorm:"user_id"`     //user_id
	StockId string `protobuf:"bytes,3,opt,name=stock_id,json=stockId,proto3" json:"stock_id" gorm:"stock_id"` //stock_id
	Amount  int64  `protobuf:"varint,4,opt,name=amount,proto3" json:"amount" gorm:"amount"`                   //amount
	Price   int32  `protobuf:"varint,5,opt,name=price,proto3" json:"price" gorm:"price"`                      //price
}
...
var file_db_proto_rawDesc = []byte{
	0x0a, 0x08, 0x64, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x48, 0x0a, 0x06, 0x44, 0x42,
	...
	0x77, 0x6f, 0x72, 0x64, 0x22, 0x7f, 0x0a, 0x0b, 0x44, 0x42, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74,
	...
	0x73, 0x74, 0x6f, 0x63, 0x6b, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70,
